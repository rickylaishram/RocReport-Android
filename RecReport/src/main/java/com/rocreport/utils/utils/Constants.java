package com.rocreport.utils.utils;
...
public class Constants {
    ...
    public static String API_GET_STORIES = "stories.json";
    public static String API_GET_LOCATIONS = "locations.json";
    public static String API_GET_STORY_FRAGMENTS = "story_fragments.json";*/


    public static String IMGUR_ENDPOINT = "https://api.imgur.com/3/";
    public static String IMGUR_UPLOAD = "image";
